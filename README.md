...
eziri: Version 1.0.0 2026-06-29
Joseph Faherty

USAGE: eziri \path\to\image image-width image-height
...
>>> This program's goal is to offload tedious ImageJ work. 
	It isn't better than you at this, it just doesn't get tired.
>>> Eziri cannot save bad images. If you can't count it, eziri can't either. 
	Even if you have a hard time discerning between crystals, eziri probably won't work.
